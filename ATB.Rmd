...
ecoli_AFP %>% select(Name, `Gene symbol`, `Hierarchy node`, Class, Subclass, `% Coverage of reference sequence`, `% Identity to reference sequence`) %>% write_csv(file="ATB_Ecoli_AFP.csv")
...
write.csv(salmonella_AFP, file="ATB_Salmonella_AFP.csv")
...
write.csv(pseudomonas_AFP, file="ATB_Pseudomonas_aeruginosa_AFP.csv")
