...
enterobacter_AFP <- read_tsv_chunked("/Users/ipmbkhot/Library/CloudStorage/GoogleDrive-drkatholt@gmail.com/My Drive/AMRnet/resistance rules/AMRFP_results.tsv.gz", DataFrameCallback$new(f), chunk_size = 10000)

```

``` {r}
# write out with species annotated
enterobacter_AFP %>% full_join(enterobacter_genus, by=join_by("Name"=="Sample")) %>% write_tsv(file="ATB_Enterobacter_AFP.tsv")
