...
species_calls <- read_tsv("genotypes/ATB_species_calls.tsv.gz")
...
afp <-read_tsv("genotypes/ATB_Pseudomonas_aeruginosa_AFP.tsv.gz") %>% 
...
afp_status <- read_tsv("genotypes/ATB_AMRFP_status.tsv.gz") %>% 
...
# identify parent nodes for OXA genes
...
ast<-read_delim("AST_Pseudomonas_aeruginosa.tsv.gz") %>% rename(BioSample=`#BioSample`)
